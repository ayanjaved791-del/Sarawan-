...
export const EXACT_SARAWAN_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    price: 600,
    variants: [
      { id: 'half-darzen', name: 'Half Darzen', price: 600 },
      { id: 'full-darzen', name: 'Full Darzen', price: 1200 },
    ],
    available: true,
  ...
  },
  {
    ...
    price: 550,
    variants: [
      { id: 'single', name: 'Single', price: 300 },
      { id: 'plate', name: 'Plate', price: 550 },
    ],
    available: true,
    isPopular: true,
    image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&auto=format&fit=crop&q=80',
  },
  {
    ...
    price: 600,
    variants: [
      { id: 'single', name: 'Single', price: 320 },
      { id: 'plate', name: 'Plate', price: 600 },
    ],
    available: true,
    image: 'https://images.unsplash.com/photo-1603360946369-dc9bb6258143?w=800&auto=format&fit=crop&q=80',
  },
  ...
  },
  {
    ...
    price: 650,
    variants: [
      { id: 'single', name: 'Single', price: 350 },
      { id: 'plate', name: 'Plate', price: 650 },
    ],
    available: true,
    isPopular: true,
    image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=800&auto=format&fit=crop&q=80',
  ...
  // ==================== CHICKEN KARAHI ====================
  {
    ...
    price: 500,
    variants: [
      { id: 'plate', name: 'Plate', price: 500 },
      { id: 'half', name: 'Half', price: 1000 },
      { id: 'full', name: 'Full', price: 2000 },
    ],
    available: true,
    isPopular: true,
  ...
  },
  {
    ...
    variants: [
      { id: 'plate', name: 'Plate', price: 550 },
      { id: 'half', name: 'Half', price: 1100 },
      { id: 'full', name: 'Full', price: 2200 },
    ],
    available: true,
  ...
  },
  {
    ...
    price: 1200,
    variants: [
      { id: 'half', name: 'Half', price: 1200 },
      { id: 'full', name: 'Full', price: 2400 },
    ],
    available: true,
    isSpecial: true,
    image: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=800&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    price: 1300,
    variants: [
      { id: 'half', name: 'Half', price: 1300 },
      { id: 'full', name: 'Full', price: 2600 },
    ],
    available: true,
    image: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=800&auto=format&fit=crop&q=80',
  },
  ...
  },
  {
    ...
    price: 1500,
    variants: [
      { id: 'half', name: 'Half', price: 1500 },
      { id: 'full', name: 'Full', price: 3000 },
    ],
    available: true,
    isSpecial: true,
    isPopular: true,
  ...
  },
  {
    ...
    price: 1400,
    variants: [
      { id: 'half', name: 'Half', price: 1400 },
      { id: 'full', name: 'Full', price: 2800 },
    ],
    available: true,
    image: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=800&auto=format&fit=crop&q=80',
  },
  ...
  },
  {
    ...
    price: 350,
    variants: [
      { id: 'plate', name: 'Plate', price: 350 },
      { id: 'half', name: 'Half', price: 600 },
    ],
    available: true,
    image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=800&auto=format&fit=crop&q=80',
  },
  {
    ...
    price: 400,
    variants: [
      { id: 'plate', name: 'Plate', price: 400 },
      { id: 'half', name: 'Half', price: 700 },
    ],
    available: true,
    isSpecial: true,
    image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=800&auto=format&fit=crop&q=80',
  ...
  // ==================== BROAST ====================
  {
    ...
    price: 480,
    variants: [
      { id: 'leg', name: 'Leg', price: 480 },
      { id: 'chest', name: 'Chest', price: 550 },
    ],
    available: true,
    isPopular: true,
  ...
  },
  {
    ...
    price: 500,
    variants: [
      { id: 'leg', name: 'Leg', price: 500 },
      { id: 'chest', name: 'Chest', price: 600 },
    ],
    available: true,
    image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=800&auto=format&fit=crop&q=80',
  },
  {
    ...
    price: 550,
    variants: [
      { id: 'leg', name: 'Leg', price: 550 },
      { id: 'chest', name: 'Chest', price: 650 },
    ],
    available: true,
  ...
  // ==================== ICE CREAM ====================
  {
    ...
    price: 200,
    variants: [
      { id: 'single', name: 'Single Scope', price: 200 },
      { id: 'double', name: 'Double Scope', price: 200 },
    ],
    available: true,
